import { languageFiles } from "../renderer";
...
export function onHashChange() {
    switch (location.hash) {
        case "#languages":
            ...
            setMenu(0);
            setScreen(0);
            LanguagesController.show(languageFiles, buttons);
            break;
        case "#recipes":
            title.html("Recipe Editor");
            setMenu(1);
            setScreen(1);
            RecipesController.show(buttons);
            break;
        case "#blockstates":
        ...
        case "#viewer":
            ...
            setMenu(7);
            setScreen(7);
            TexturesController.viewTextures(buttons);
            break;
        case "#tiler":
            title.html("Texture Tiler");
            setMenu(8);
            setScreen(8);
            TexturesController.viewTiler(buttons);
            break;
        case "#analyzer":
